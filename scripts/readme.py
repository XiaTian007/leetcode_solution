...
class Config:
    ...
    """
    local_path = 'H:/newproject/algorithms_and_oj-master'
    # solution of leetcode
    github_leetcode_url = 'https://github.com/XiaTian007/leetcode_solution/blob/master/leetcode-algorithms/'
    ...
    def __create_folder(self, oj_name):
        ...
        for item in self.table_item.values():
            ...
            if not os.path.exists(question_folder_name):
                ...
                os.mkdir(question_folder_name.strip('?'))
